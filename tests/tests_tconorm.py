...
import fuzzy.logic.operations.tconorm as tconorm
import unittest
...
class TestTconorm(unittest.TestCase):
    ...
    def test_fmax_none(self):
        self.raising_tconorm(tconorm.fmax, None, 3, ValueError)
        self.raising_tconorm(tconorm.fmax, None, None, ValueError)
        self.raising_tconorm(tconorm.fmax, 0, None, ValueError)
    ...
    def test_prob_none(self):
        self.raising_tconorm(tconorm.probabilistic_sum, None, 3, ValueError)
        self.raising_tconorm(tconorm.probabilistic_sum, None, None, ValueError)
        self.raising_tconorm(tconorm.probabilistic_sum, 0, None, ValueError)
    ...
    def test_bounded_none(self):
        self.raising_tconorm(tconorm.bounded_sum, None, 3, ValueError)
        self.raising_tconorm(tconorm.bounded_sum, None, None, ValueError)
        self.raising_tconorm(tconorm.bounded_sum, 0, None, ValueError)
    ...
    def test_drastic_none(self):
        self.raising_tconorm(tconorm.drastic, None, 3, ValueError)
        self.raising_tconorm(tconorm.drastic, None, None, ValueError)
        self.raising_tconorm(tconorm.drastic, 0, None, ValueError)
    ...
    def test_nilpotent_none(self):
        self.raising_tconorm(tconorm.nilpotent_max, None, 3, ValueError)
        self.raising_tconorm(tconorm.nilpotent_max, None, None, ValueError)
        self.raising_tconorm(tconorm.nilpotent_max, 0, None, ValueError)
    ...
    def test_einstein_none(self):
        self.raising_tconorm(tconorm.einstein_sum, None, 3, ValueError)
        self.raising_tconorm(tconorm.einstein_sum, None, None, ValueError)
        self.raising_tconorm(tconorm.einstein_sum, 0, None, ValueError)
